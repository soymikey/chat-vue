  ...
  <div class="explore_container">
    ...
    >
      <button-tab v-model="tabIndex">
        ...
        <button-tab-item @on-item-click="registerTab">注册
      ...
      <x-button class="button" @click.native="tabIndex===0?login():signUp()"  type="primary" :show-loading='loading'>{{tabIndex===0?'登陆':'注册'}}</x-button>
    </scroller>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    signUp () {
      ...
      } else if (this.signForm.regcode.toLowerCase() !== this.initCode.toLowerCase()) {
